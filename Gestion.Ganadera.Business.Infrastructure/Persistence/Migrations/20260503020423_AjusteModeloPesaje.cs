...
{
    /// <inheritdoc />
    public partial class AjusteModeloPesaje : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "Evento_Detalle_Pesaje",
                schema: "Ganaderia",
                columns: table => new
                {
                    Evento_Ganadero_Codigo = table.Column<long>(type: "bigint", nullable: false),
                    Evento_Detalle_Pesaje_Fecha = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Evento_Detalle_Peso = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    Evento_Detalle_Pesaje_Observacion = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Evento_Detalle_Pesaje", x => x.Evento_Ganadero_Codigo);
                    table.ForeignKey(
                        name: "FK_Evento_Detalle_Pesaje_Evento_Ganadero_Evento_Ganadero_Codigo",
