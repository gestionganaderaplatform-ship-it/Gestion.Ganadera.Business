...
namespace Gestion.Ganadera.Business.Infrastructure.Persistence
{
    ...
    public sealed class AppDbContextDesignTimeFactory : IDesignTimeDbContextFactory<AppDbContext>
    {
        ...
        private static string ResolveApiDirectory()
        {
            ...
            {
                currentDirectory,
                Path.Combine(currentDirectory, "Gestion.Ganadera.Business.API"),
                Path.GetFullPath(Path.Combine(currentDirectory, "..", "Gestion.Ganadera.Business.API"))
            };
            ...
            throw new DirectoryNotFoundException(
                "No fue posible ubicar la carpeta Gestion.Ganadera.Business.API para resolver la configuracion de EF Core.");
        }
    }
}
